...
const ProductCard = ({ name, description, imageSrc, category }: ProductCardProps) => {
  return (
    <motion.div 
      ...
      className="bg-brown-dark rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-transparent hover:border-transparent"
    >
